...
interface MutableSCProps {
  // SC mean Styled Components
...
const Container = styled.div<MutableSCProps>`
  ...
  background: ${({ defaultTheme }) =>
    defaultTheme
      ? "#FFF"
      : `linear-gradient(rgba(1, 95, 201, .9), rgba(1, 95, 201, .9)), url(${process.env.PUBLIC_URL}/assets/appointment/appointment.jpg)`};
...
const Appointment = ({ defaultTheme }: AppointmentProps) => {
  return (
    <Container defaultTheme={defaultTheme}>
      <Row>
        <Left>
          <LeftTitle defaultTheme={defaultTheme}>
            We're Award Winning Insurance Company
          </LeftTitle>
          <LeftDescription defaultTheme={defaultTheme}>
          ...
          <ContactContainer defaultTheme={defaultTheme}>
            <Contact defaultTheme={defaultTheme}>
              <Image
                src={`${process.env.PUBLIC_URL}/assets/appointment/profile.jpg`}
              />
              <ContactInfo defaultTheme={defaultTheme}>
